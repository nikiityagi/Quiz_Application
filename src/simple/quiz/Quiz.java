...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        setBounds(100, 50, 1240, 750);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("simple/quiz/icon/quiz.jpg"));
        JLabel l1 = new JLabel(i1);
        l1.setBounds(0, 0, 1240, 292);
        add(l1);
    ...
    public void paint(Graphics g){
        ...
        if(timer > 0) {
            g.drawString(time, 950, 300);
        }else {
            g.drawString("Times Up!!", 950, 300);
        }
